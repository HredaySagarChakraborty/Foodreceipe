...
public class AdapterEng2 extends RecyclerView.Adapter<AdapterEng2.ViewHolder> {
    ...
    public AdapterEng2(Context context, List<EngPojoClass2> list) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
       ...
       EngPojoClass2 hh = list.get(position);
    ...
    public  void setOnItemClickListener(ClickListener clickListener){
        ...
        AdapterEng2.clickListener=clickListener;
    }
