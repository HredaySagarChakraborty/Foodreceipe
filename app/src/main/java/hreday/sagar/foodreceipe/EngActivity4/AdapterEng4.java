...
public class AdapterEng4 extends RecyclerView.Adapter<AdapterEng4.ViewHolder> {
    ...
    public AdapterEng4(Context context, List<EngPojoClass4> list) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
       ...
       EngPojoClass4 hh = list.get(position);
    ...
    public  void setOnItemClickListener(ClickListener clickListener){
        ...
        AdapterEng4.clickListener=clickListener;
    }
