...
public class AdapterEng5 extends RecyclerView.Adapter<AdapterEng5.ViewHolder> {
    ...
    public AdapterEng5(Context context, List<EngPojoClass5> list) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
       ...
       EngPojoClass5 hh = list.get(position);
    ...
    public  void setOnItemClickListener(ClickListener clickListener){
        ...
        AdapterEng5.clickListener=clickListener;
    }
