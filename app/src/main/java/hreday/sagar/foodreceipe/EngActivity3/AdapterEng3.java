...
public class AdapterEng3 extends RecyclerView.Adapter<AdapterEng3.ViewHolder> {
    ...
    public AdapterEng3(Context context, List<EngPojoClass3> list) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
       ...
       EngPojoClass3 hh = list.get(position);
    ...
    public  void setOnItemClickListener(ClickListener clickListener){
        ...
        AdapterEng3.clickListener=clickListener;
    }
