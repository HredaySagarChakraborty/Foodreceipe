...
public class AdapterEng6 extends RecyclerView.Adapter<AdapterEng6.ViewHolder> {
    ...
    public AdapterEng6(Context context, List<EngPojoClass6> list) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        EngPojoClass6 hh = list.get(position);
    ...
    public  void setOnItemClickListener(ClickListener clickListener){
        ...
        AdapterEng6.clickListener=clickListener;
    }
